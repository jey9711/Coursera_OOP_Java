...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			BasicDocument basicDoc = new BasicDocument(stringFromFile);
			basicDoc.getFleschScore();
			long basicEndTime = System.nanoTime();
			long basicEstTime = (basicEndTime - basicStartTime);
			
			long efficientStartTime = System.nanoTime();
			EfficientDocument efficientDoc = new EfficientDocument(stringFromFile);
			efficientDoc.getFleschScore();
			long efficientEndTime = System.nanoTime();
			long efficientEstTime = (efficientEndTime - efficientStartTime);
			
			System.out.println(numToCheck + "\t" + basicEstTime + "\t" + efficientEstTime);
